    ...
    if($responseKey['success'])
    {
        if($unameOK == true && $passwordOK == true && $fnameOK == true && $lnameOK == true && $emailOK == true)
        {
            ...
            if(mysqli_query($conn, $sql)){
                //send mail
                $to = $email;
                $subject = "Email megerősítése - CARDBUDDIES";
                $message = "<a href='http://localhost/CardBuddies/verifyEmail.php?vkey=$vkey'>Register Account</a>";
                $altMessage = "Email megerősítéshez szükséges link: http://localhost/CardBuddies/verifyEmail.php?vkey=$vkey";
...
<head>
    <meta charset="utf-8">
    <title>CARDBUDDIES | REGISZTRÁCIÓ</title>
